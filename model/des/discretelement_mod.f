...
! and is saved so restarts begin at the correct count, StressStrain-Wesley
      INTEGER VTP_FINDEX, TECPLOT_FINDEX, SS_FINDEX
...
! DES Attrition Model
      ...
      double precision FYL
      double precision FXR
      double precision FYR
      double precision FXT
      double precision FYT
      double precision FXB
      double precision FYB
