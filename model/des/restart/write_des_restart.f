...
! WESLEY WRITE LINKS INTO .RES FILE
         CALL DES_WRITEPAR(LRES_UNIT,LINKS(:,1),PIP,LNEXT_REC)
         DO LI=2, MAXNEIGHBORS
            CALL DES_WRITEPAR(LRES_UNIT, LINKS(:,LI), PIP, LNEXT_REC)
         END DO 
...
! WESLEY WRITE LINKS INTO .RES FILE
         CALL DES_GATHERWRITE(LRES_UNIT, LINKS(:,1), LGLOCNT, LNEXT_REC)
         DO LI=2, MAXNEIGHBORS
            CALL DES_GATHERWRITE(LRES_UNIT, LINKS(:,LI), LGLOCNT, LNEXT_REC, PLOC2GLB=.TRUE.)
         END DO
