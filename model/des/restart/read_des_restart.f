...
! WESLEY READ LINKS FROM .RES FILE
       CALL IN_BIN_512(LRES_UNIT, LINKS(:,1), PIP, LNEXT_REC)
       DO LI = 2, MAXNEIGHBORS
          CALL IN_BIN_512I(LRES_UNIT, LINKS(:,LI), PIP, LNEXT_REC)
       END DO
...
! WESLEY READ LINKS FROM .RES FILE
        CALL DES_READSCATTER(LRES_UNIT, LINKS(:,1), LGLOCNT, LNEXT_REC)
        DO LI = 2, MAXNEIGHBORS
           CALL DES_READSCATTER(LRES_UNIT, LINKS(:,LI), LGLOCNT, LNEXT_REC)
        END DO	
